...
const quickLinks = [
  {
    label: 'Profil Saya',
    desc: 'Lihat informasi akun dan data dosen wali',
  ...
  },
  {
    ...
    desc: 'Kelola kode undangan untuk mahasiswa bimbingan',
    href: '/lecturer/join-code',
    icon: QrCode,
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 px-4 py-6 md:px-6 lg:px-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Kelola akun dan keamanan Anda</p>
      </div>
      ...
      <section className="flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Perbarui password akun Anda secara berkala untuk keamanan</p>
          </div>
        </div>
